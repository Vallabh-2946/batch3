      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#roadmap" className="text-gray-700 hover:text-[#001f3f] transition-colors">Roadmap</a>
            <a href="#about" className="text-gray-700 hover:text-[#001f3f] transition-colors">About</a>
          </nav>
